    ...
    for epoch in tqdm(range(hp.epochs)):
        ...
        for i, batchs in enumerate(loader):
            ...
            for j, data_of_batch in enumerate(batchs):
                ...
                # print('loaded data', time.perf_counter() - start_time)
                # Forward
                ...
                # print('calculated', time.perf_counter() - start_time)
                # Logger
                t_l = total_loss.item()
                m_l = mel_loss.item()
                ...
                # print('logged', time.perf_counter() - start_time)
                # Backward
                ...
                # print('finalized', time.perf_counter() - start_time)
                # Print
            ...
            # print(time.perf_counter() - batch_start)
